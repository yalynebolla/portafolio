        ...
        <div className="max-w-2xl w-full px-6">
          <div className="rounded-xl shadow-lg p-8 mb-8" style={{ background: "#fff", border: "2px solid var(--accent)" }}>
            ...
            <div className="flex flex-col items-center justify-center min-h-[200px]">
              <img src="/analisis1.png" alt="Análisis de Transportadoras" className="w-full max-w-md rounded-lg shadow mb-4" />
            </div>
          ...
          <div className="rounded-xl shadow-lg p-8 mb-8" style={{ background: "#fff", border: "2px solid var(--accent)" }}>
            ...
            <div className="flex flex-col items-center justify-center min-h-[200px]">
              <img src="/analisis2.png" alt="Recursos Humanos" className="w-full max-w-md rounded-lg shadow mb-4" />
            </div>
            <p className="mt-4" style={{ color: "#222" }}>
